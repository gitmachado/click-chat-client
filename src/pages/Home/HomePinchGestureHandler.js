...
const App = () => {
    ...
    const { socket, homeImageViewerModalVisible, setHomeImageViewerModalVisible, appConfig, imageViewerPhoto, setChatImageViewerModalVisible, setImageViewerModalVisible, setConversasDoAsync, conversasDoAsync, imageViewerModalVisible, setImageViewerPhoto, conversationMessages, setConversationMessages, currentConversation, setCurrentConversation } = useContext(AppContext);
    ...
    return (
        <View style={{ width: '100%', height: '100%', position: 'absolute', backgroundColor: appConfig.darkTheme ? '#111b21' : 'black' }}>
            <PanGestureHandler
            ...
            <View style={{ height: 65, width: '100%', borderWidth: 0, backgroundColor: appConfig.darkTheme ? '#202c33' : '#ff9900', position: 'absolute', marginTop: 24, flexDirection: 'row', elevation: 5 }}>
                <View style={{ width: '11%', height: '100%', borderWidth: 0, justifyContent: 'center', alignItems: 'center' }}>
                    <TouchableOpacity activeOpacity={0.5} style={styles.backButton} onPress={() => { setHomeImageViewerModalVisible(false); }}>
